...
public class MusicFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Button search_button=(Button)getActivity().findViewById(R.id.Search_musicbutton);
        editText=(EditText)getActivity().findViewById(R.id.Input_musictext);
        container=(CoordinatorLayout)getActivity().findViewById(R.id.musiccontainer);
