...
public class SearchItemBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.searchitem_image, 1);
        sViewsWithIds.put(R.id.searchitem_title, 2);
    }
    // views
    @NonNull
    private final android.widget.LinearLayout mboundView0;
    @NonNull
    public final android.widget.ImageView searchitemImage;
    @NonNull
    public final android.widget.TextView searchitemTitle;
    // variables
    // values
    // listeners
    ...
    public SearchItemBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.searchitemImage = (android.widget.ImageView) bindings[1];
        this.searchitemTitle = (android.widget.TextView) bindings[2];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static SearchItemBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<SearchItemBinding>inflate(inflater, com.example.lenovo.doubanapplication.R.layout.search_item, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static SearchItemBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.lenovo.doubanapplication.R.layout.search_item, null, false), bindingComponent);
    }
    @NonNull
